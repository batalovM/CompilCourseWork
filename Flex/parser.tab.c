...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ConstDeclaration = 14,          /* ConstDeclaration  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "CONST", "VAL",
  "COLON", "EQUALS", "SEMICOLON", "FLOAT_NUMBER", "IDENTIFIER", "DOUBLE",
  "FLOAT", "INT", "$accept", "ConstDeclaration", "Type", "Identifier",
  "Value", YY_NULLPTR
};
...
{
       8,     9,    10,     1,     4,     3,     5,     7,     0,    12,
       0,     0,     0,    13,    15
};

static const yytype_int8 yycheck[] =
{
      10,    11,    12,     3,     0,     4,     9,     5,    -1,     6,
      -1,    -1,    -1,     8,     7
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* ConstDeclaration: CONST VAL Identifier COLON Type EQUALS Value SEMICOLON  */
#line 36 "parser.y"
                                                           {
